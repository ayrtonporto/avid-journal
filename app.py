...
def _build_publication_section(results: List[dict], tex_path: str) -> str:
    ...
    if publishable:
        ...
        <div class="pub-section" style="border:1px solid #7a1f2b;padding:28px;margin-top:28px;background:rgba(122,31,43,0.04);max-width:720px">
          ...
          <div class="pub-terms" style="margin-top:20px;padding:16px;background:#faf9f6;border:1px solid #e3e2dd;font-family:Inter,sans-serif;font-size:12.5px;color:#73726c;max-height:120px;overflow-y:auto;line-height:1.5">
            <b style="color:#111110">AViD Journal — Terms of Publication</b><br><br>
            By submitting, you confirm that:<br>
            1. This paper was generated by an LLM and you have disclosed which model(s) were used.<br>
            2. You grant AViD Journal the right to publish, distribute, and archive this paper.<br>
            3. The theorems have been verified as novel by the AViD pipeline (D1 + D2).<br>
            4. You understand submission does not guarantee publication — all papers undergo editorial review.<br>
            5. You will be notified at the provided email when a decision is made.
          </div>
