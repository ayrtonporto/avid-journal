...
**Anotación de fidelidad del autor agregada 2026-07-14.** Columna `author_fidelity` en el CSV congelado: 4 fiel, 1 aproximación, 2 incorrecto, 3 no formalizado. Hallazgos: (a) el juez LLM dio falso-pase a 3/7 papers (1101.3720v1, 0904.1783v3, math/0504586v2) — definiciones placeholder o teoremas trivializados que compilaron pero no son fieles; (b) nuevos modos de ilusión detectados: `:= sorry` en definiciones auxiliares (Paper 8), dirección única de un iff (Paper 9), teorema trivializado con definiciones placeholder (Paper 10); (c) asimetría retirados/controles: 4/4 retirados fieles vs 0/3 controles fieles — posible sesgo de selección (los controles tienen enunciados más largos/complejos, elegidos por emparejamiento temático sin considerar formalizabilidad).
