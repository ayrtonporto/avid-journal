...
**Evidencia de funcionamiento.** El pipeline corre de extremo a extremo. Formalizó 7 de 10 papers en el estudio profundo (Run 002). D2 acertó en 22 de 24 teoremas del eval set (91.7%), con 2 casos de expectativa ambigua (T19 de origen LLM, T22 de equivalencia sintactica) y cero falsos positivos o negativos en la corrida reportada. D1 C_F encontro los 18 teoremas no triviales que alcanzaron esa etapa (100% de cobertura sobre no triviales); los 6 restantes fueron detenidos por D2 sin llegar a D1. D3 produjo una escalera de distancias consistente con el juicio humano en los 3 pares calibrados con etiqueta firmada por el autor (T07: same_disguised, T08 y T09: genuinely_different), mas 2 controles correctos (self, unrelated).
...
**Evidencia metodológica.** La construcción del dataset de 33 papers retirados por duplicación, con 52 controles emparejados por categoría y año, establece un benchmark reusable. La comparación de cuatro modelos de formalización (Qwen 3.7-max 5/5, GLM-5.2 3/5, DeepSeek Pro 0/5, DeepSeek Flash 0/5) cuantifica la viabilidad relativa de distintos backends. Los defectos metodológicos del wide study v1 (self-matches por falta de auto-exclusión, 38/52 papers sin scores) quedan documentados como advertencia para trabajos futuros que usen TheoremSearch como fuente.
